...
function drawBox(cxt, i, j, nums) {
    ...
    switch (nums) {
        ...
        case 2:
            ...
            cxt.fillText("夏", x + box_width / 2, y + box_width / 2);
            break;
        case 4:
            ...
            cxt.beginPath();
            cxt.fillStyle = color_text1;
            cxt.fillText("商", x + box_width / 2, y + box_width / 2);
            break;
        case 8:
            ...
            cxt.fillText("周", x + box_width / 2, y + box_width / 2);
            break;
        case 16:
            ...
            cxt.beginPath();
            cxt.fillStyle = color_text2;
            cxt.fillText("秦", x + box_width / 2, y + box_width / 2);
            break;
        case 32:
            ...
            cxt.beginPath();
            cxt.fillStyle = color_text2;
            cxt.fillText("汉", x + box_width / 2, y + box_width / 2);
            break;
        case 64:
            ...
            cxt.beginPath();
            cxt.fillStyle = color_text2;
            cxt.fillText("晋", x + box_width / 2, y + box_width / 2);
            break;
        case 128:
            ...
            cxt.fillStyle = color_text2;
            cxt.fillText("北", x + box_width / 2, y + box_width / 2);
            break;
        case 256:
            ...
            cxt.font = (0.95 * numSize) + "px Arial";
            cxt.fillStyle = color_text2;
            cxt.fillText("隋", x + box_width / 2, y + box_width / 2);
            break;
        case 512:
            ...
            cxt.font = (0.95 * numSize) + "px Arial";
            cxt.fillStyle = color_text2;
            cxt.fillText("唐", x + box_width / 2, y + box_width / 2);
            break;
        case 1024:
            ...
            cxt.fillStyle = color_text2;
            cxt.fillText("宋", x + box_width / 2, y + box_width / 2);
            break;
        case 2048:
            ...
            cxt.font = (0.9 * numSize) + "px Arial";
            cxt.fillStyle = color_text2;
            cxt.fillText("元", x + box_width / 2, y + box_width / 2);
            break;
        case 4096:
            ...
            cxt.font = (0.9 * numSize) + "px Arial";
            cxt.fillStyle = color_text2;
            cxt.fillText("明", x + box_width / 2, y + box_width / 2);
            break;
        case 8192:
            ...
            cxt.font = (0.9 * numSize) + "px Arial";
            cxt.fillStyle = color_text2;
            cxt.fillText("清", x + box_width / 2, y + box_width / 2);
            break;
        default:
            break
    }
