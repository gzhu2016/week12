   ...
   var y = (j + 1) * margin + margin_top + j * box_width
    ...
    switch (nums) {
        ...
        case 2:
            ...
            if(nums==2)
            cxt.fillText("小白", x + box_width / 2, y + box_width / 2)
            break;
        case 4:
            ...
            cxt.fillStyle = color_text1
            if(nums==4)
                cxt.fillText("大白", x + box_width / 2, y + box_width / 2)
            break;
        case 8:
            ...
            if(nums==8)
                cxt.fillText("入门", x + box_width / 2, y + box_width / 2)
            break;
        case 16:
            ...
            cxt.fillStyle = color_text2
            if(nums==16)
                cxt.fillText("初学", x + box_width / 2, y + box_width / 2)
            break;
        case 32:
            ...
            cxt.fillStyle = color_text2
            if(nums==32)
                cxt.fillText("中级", x + box_width / 2, y + box_width / 2)
            break;
        case 64:
            ...
            cxt.fillStyle = color_text2
            if(nums==64)
                cxt.fillText("高级", x + box_width / 2, y + box_width / 2)
            break;
        case 128:
            ...
            cxt.fillStyle = color_text2
            if(nums==128)
                cxt.fillText("牛逼", x + box_width / 2, y + box_width / 2)
            break;
        case 256:
            ...
            cxt.fillStyle = color_text2
            if(nums==256)
                cxt.fillText("大神", x + box_width / 2, y + box_width / 2)
            break;
        case 512:
            ...
            cxt.fillStyle = color_text2
            if(nums==512)
                cxt.fillText("巨屌", x + box_width / 2, y + box_width / 2)
            break;
        case 1024:
            ...
            cxt.fillStyle = color_text2
            if(nums==1024)
                cxt.fillText("无敌", x + box_width / 2, y + box_width / 2)
            break;
        case 2048:
            ...
            cxt.fillStyle = color_text2
            if(nums==2048)
                cxt.fillText("炼狱", x + box_width / 2, y + box_width / 2)
            break;
        case 4096:
            ...
            cxt.fillStyle = color_text2
            if(nums==4096)
                cxt.fillText("绝世", x + box_width / 2, y + box_width / 2)
            break;
        case 8192:
            ...
            cxt.fillStyle = color_text2
            if(nums==8192)
                cxt.fillText("求败", x + box_width / 2, y + box_width / 2)
            break
        default:
            break
    }
