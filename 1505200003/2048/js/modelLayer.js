...
var numSize = 0.09 * documentWidth
...
var color_256 = "black"
var color_512 = "white"
var color_1024 = "black"
var color_2048 = "white"
var color_4096 = "black"
var color_8192 = "white"
var color_text1 = "black"
var color_text2 = "white"
...
function drawBox(cxt, i, j, nums) {
    ...
    switch (nums) {
        ...
        case 2:
            ...
            cxt.fillText("卒", x + box_width / 2, y + box_width / 2)
            break;
        case 4:
            ...
            cxt.fillText("兵", x + box_width / 2, y + box_width / 2)
            break;
        case 8:
            ...
            cxt.beginPath()
            cxt.fillStyle = color_text1
            cxt.fillText("骑士", x + box_width / 2, y + box_width / 2)
            break;
        case 16:
            ...
            cxt.beginPath()
            cxt.fillStyle = color_text2
            cxt.fillText("城堡", x + box_width / 2, y + box_width / 2)
            break;
        case 32:
            ...
            cxt.beginPath()
            cxt.fillStyle = color_text1
            cxt.fillText("男爵", x + box_width / 2, y + box_width / 2)
            break;
        case 64:
            ...
            cxt.beginPath()
            cxt.fillStyle = color_text2
            cxt.fillText("子爵", x + box_width / 2, y + box_width / 2)
            break;
        case 128:
            ...
            cxt.fillStyle = color_text1
            cxt.fillText("伯爵", x + box_width / 2, y + box_width / 2)
            break;
        case 256:
            ...
            cxt.font = (0.95 * numSize) + "px Arial"
            cxt.fillStyle = color_text2
            cxt.fillText("侯爵", x + box_width / 2, y + box_width / 2)
            break;
        case 512:
            ...
            cxt.font = (0.95 * numSize) + "px Arial"
            cxt.fillStyle = color_text1
            cxt.fillText("公爵", x + box_width / 2, y + box_width / 2)
            break;
        case 1024:
            ...
            cxt.fillStyle = color_text2
            cxt.fillText("大公", x + box_width / 2, y + box_width / 2)
            break;
        case 2048:
            ...
            cxt.font = (0.9 * numSize) + "px Arial"
            cxt.fillStyle = color_text1
            cxt.fillText("主教", x + box_width / 2, y + box_width / 2)
            break;
        case 4096:
            ...
            cxt.font = (0.9 * numSize) + "px Arial"
            cxt.fillStyle = color_text2
            cxt.fillText("王后", x + box_width / 2, y + box_width / 2)
            break;
        case 8192:
            ...
            cxt.font = (0.9 * numSize) + "px Arial"
            cxt.fillStyle = color_text1
            cxt.fillText("国王", x + box_width / 2, y + box_width / 2)
            break
        default:
            break
    }
